...
public class barang {
    ...
    public barang(String noBarang, String kodBarang, String jenBarang, String satBarang, int hbeliBarang, int hjualBarang){
      ...
      //method overload
        ...
        return getNomorBarang()+getKodeBarang()+getJenisBarang()+getSatuanBarang()+getHargaBeliBarang()+getHargaJualBarang()+getStokBarang()+getTanggalBarang()+getUsernameBarang();
    }
